...
impl ClaimGenerator {
    ...
    pub fn write_trace(
        ...
        for inputs in sub_component_inputs.pedersen_points_table_window_bits_18 {
            add_inputs(pedersen_points_table_window_bits_18_state, &inputs, n_active_rows, 0);
        }
