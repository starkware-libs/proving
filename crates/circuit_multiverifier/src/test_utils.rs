...
pub const PRIVACY_CAIRO_VERIFIER_PREPROCESSED_ROOT: [u32; 8] =
    [2800072781, 102332298, 1251937666, 3128580490, 3302328928, 3686299726, 731210624, 2448472477];

/// The preprocessed root of the multiverifier circuit.
pub const MULTIVERIFIER_PREPROCESSED_ROOT: [u32; 8] = [
    1988588251, 2709433825, 2058907892, 3025073627, 2010729224, 3739294047, 2206650889, 2930960222,
];
