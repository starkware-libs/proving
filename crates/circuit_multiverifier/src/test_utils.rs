...
pub const PRIVACY_CAIRO_VERIFIER_PREPROCESSED_ROOT: [u32; 8] = [
    1719804112, 1849645252, 3721840512, 3685889303, 1649992509, 3571010544, 3790161538, 3372846539,
];

/// The preprocessed root of the multiverifier circuit.
pub const MULTIVERIFIER_PREPROCESSED_ROOT: [u32; 8] =
    [2836342751, 2855442286, 2434246275, 645257771, 3950246156, 11964093, 1982673410, 1440549293];
