...
pub const PRIVACY_CAIRO_VERIFIER_PREPROCESSED_ROOT: [u32; 8] = [
    3983032595, 2484212084, 1402473267, 1229121792, 3428887386, 2320379097, 2318709749, 3885483817,
];

/// The preprocessed root of the multiverifier circuit.
pub const MULTIVERIFIER_PREPROCESSED_ROOT: [u32; 8] =
    [3820930301, 1346109335, 1829095105, 3435250389, 812227641, 3998447204, 753460394, 807851602];
