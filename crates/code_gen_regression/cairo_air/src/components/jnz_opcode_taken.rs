    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        eval.add_constraint(
            ((((((((((((((((((((((((((((((diff_from_p_tmp_f51a9_10
                .clone()
                * diff_from_p_tmp_f51a9_10.clone())
                + dst_limb_1_col9.clone())
                + dst_limb_2_col10.clone())
                + dst_limb_3_col11.clone())
                + dst_limb_4_col12.clone())
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [read_small_output_tmp_f51a9_22_limb_0] = ReadSmall::evaluate(
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            -E::EF::from(enabler.clone()),
            &[
                (input_pc_col0.clone() + read_small_output_tmp_f51a9_22_limb_0.clone()),
