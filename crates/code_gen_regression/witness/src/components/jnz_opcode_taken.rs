        ...
        .for_each(
            |(row_index, (mut row, lookup_data, sub_component_inputs, jnz_opcode_taken_input))| {
                ...
                *lookup_data.memory_id_to_big_0 = [
                ...
                let read_positive_num_bits_252_output_tmp_f51a9_9 = (
                ...
                let res_col36 = ((((((((((((((((((((((((((((dst_limb_0_col8)
                    ...
                    .inverse();
                *row[36] = res_col36;
                let diff_from_p_tmp_f51a9_10 = ((dst_limb_0_col8) - (M31_1));
                let diff_from_p_tmp_f51a9_11 = ((dst_limb_21_col29) - (M31_136));
                let diff_from_p_tmp_f51a9_12 = ((dst_limb_27_col35) - (M31_256));
                let res_squares_col37 = (((((((((((((((((((((((((((((diff_from_p_tmp_f51a9_10)
                    * (diff_from_p_tmp_f51a9_10))
                    + (dst_limb_1_col9))
                    + (dst_limb_2_col10))
                    + (dst_limb_3_col11))
                    + (dst_limb_4_col12))
                ...
                *row[37] = res_squares_col37;
                ...
                let memory_address_to_id_value_tmp_f51a9_13 =
                    memory_address_to_id_state.deduce_output(((input_pc_col0) + (M31_1)));
                let next_pc_id_col38 = memory_address_to_id_value_tmp_f51a9_13;
                ...
                *lookup_data.memory_address_to_id_1 =
                ...
                let memory_id_to_big_value_tmp_f51a9_15 =
                    memory_id_to_big_state.deduce_output(next_pc_id_col38);

                // Cond Decode Small Sign.

                let msb_tmp_f51a9_16 = memory_id_to_big_value_tmp_f51a9_15.get_m31(27).eq(M31_256);
                let msb_col39 = msb_tmp_f51a9_16.as_m31();
                *row[39] = msb_col39;
                let mid_limbs_set_tmp_f51a9_17 =
                    memory_id_to_big_value_tmp_f51a9_15.get_m31(20).eq(M31_511);
                let mid_limbs_set_col40 = mid_limbs_set_tmp_f51a9_17.as_m31();
                *row[40] = mid_limbs_set_col40;
                let cond_decode_small_sign_output_tmp_f51a9_18 = [msb_col39, mid_limbs_set_col40];

                let next_pc_limb_0_col41 = memory_id_to_big_value_tmp_f51a9_15.get_m31(0);
                *row[41] = next_pc_limb_0_col41;
                let next_pc_limb_1_col42 = memory_id_to_big_value_tmp_f51a9_15.get_m31(1);
                *row[42] = next_pc_limb_1_col42;
                let next_pc_limb_2_col43 = memory_id_to_big_value_tmp_f51a9_15.get_m31(2);
                *row[43] = next_pc_limb_2_col43;
                let remainder_bits_tmp_f51a9_19 =
                    ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_f51a9_15.get_m31(3)))
                        & (UInt16_3));
                let remainder_bits_col44 = remainder_bits_tmp_f51a9_19.as_m31();
                *row[44] = remainder_bits_col44;

                // Cond Range Check 2.

                let partial_limb_msb_tmp_f51a9_20 =
                    (((PackedUInt16::from_m31(remainder_bits_col44)) & (UInt16_2)) >> (UInt16_1));
                let partial_limb_msb_col45 = partial_limb_msb_tmp_f51a9_20.as_m31();
                ...
                *lookup_data.memory_id_to_big_1 = [
                ...
                let read_small_output_tmp_f51a9_22 = (
                ...
                *lookup_data.opcodes_1 = [
                    ((input_pc_col0) + (read_small_output_tmp_f51a9_22.0)),
