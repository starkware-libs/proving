...
impl ClaimGenerator {
    ...
    pub fn write_trace(
        ...
        sub_component_inputs.iter().for_each(|inputs| {
            ...
            range_check_9_9_f_state.add_packed_inputs(inputs.range_check_9_9_f.as_ref());
            range_check_9_9_g_state.add_packed_inputs(inputs.range_check_9_9_g.as_ref());
            range_check_9_9_h_state.add_packed_inputs(inputs.range_check_9_9_h.as_ref());
            range_check_20_state.add_packed_inputs(inputs.range_check_20.as_ref());
            range_check_20_b_state.add_packed_inputs(inputs.range_check_20_b.as_ref());
            range_check_20_c_state.add_packed_inputs(inputs.range_check_20_c.as_ref());
            range_check_20_d_state.add_packed_inputs(inputs.range_check_20_d.as_ref());
            range_check_20_e_state.add_packed_inputs(inputs.range_check_20_e.as_ref());
            range_check_20_f_state.add_packed_inputs(inputs.range_check_20_f.as_ref());
            range_check_20_g_state.add_packed_inputs(inputs.range_check_20_g.as_ref());
            range_check_20_h_state.add_packed_inputs(inputs.range_check_20_h.as_ref());
        });
...
struct SubComponentInputsPerRow {
    ...
    range_check_9_9: [range_check_9_9::PackedInputType; 18],
    range_check_9_9_b: [range_check_9_9_b::PackedInputType; 18],
    range_check_9_9_c: [range_check_9_9_c::PackedInputType; 18],
    range_check_9_9_d: [range_check_9_9_d::PackedInputType; 18],
    range_check_9_9_e: [range_check_9_9_e::PackedInputType; 18],
    range_check_9_9_f: [range_check_9_9_f::PackedInputType; 18],
    range_check_9_9_g: [range_check_9_9_g::PackedInputType; 9],
    range_check_9_9_h: [range_check_9_9_h::PackedInputType; 9],
    range_check_20: [range_check_20::PackedInputType; 12],
    range_check_20_b: [range_check_20_b::PackedInputType; 12],
    range_check_20_c: [range_check_20_c::PackedInputType; 12],
    range_check_20_d: [range_check_20_d::PackedInputType; 12],
    range_check_20_e: [range_check_20_e::PackedInputType; 9],
    range_check_20_f: [range_check_20_f::PackedInputType; 9],
    range_check_20_g: [range_check_20_g::PackedInputType; 9],
    range_check_20_h: [range_check_20_h::PackedInputType; 9],
}
