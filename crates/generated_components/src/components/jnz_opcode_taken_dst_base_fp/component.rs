...
mod tests {
    ...
    use super::*;
    use crate::components::constraints_regression_test_values::JNZ_OPCODE_TAKEN_DST_BASE_FP;

    #[test]
    fn jnz_opcode_taken_dst_base_fp_constraints_regression() {
        let eval = Eval {
        ...
        assert_eq!(sum, JNZ_OPCODE_TAKEN_DST_BASE_FP);
    }
}
