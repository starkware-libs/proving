...
pub const DUMP_INNER_TASK_FACT_TOPOLOGY: &str = "DUMP_INNER_TASK_FACT_TOPOLOGY";
...
// Circuit-unpacking applicative bootloader hints.
pub const LOAD_CIRCUIT_APPLICATIVE_BOOTLOADER_INPUT: &str =
    "LOAD_CIRCUIT_APPLICATIVE_BOOTLOADER_INPUT";
pub const CIRCUIT_APPLICATIVE_SETUP_VERIFIER_RUN: &str = "CIRCUIT_APPLICATIVE_SETUP_VERIFIER_RUN";
pub const CIRCUIT_APPLICATIVE_SETUP_UNPACK: &str = "CIRCUIT_APPLICATIVE_SETUP_UNPACK";
pub const CIRCUIT_APPLICATIVE_WRITE_FACT_TOPOLOGY: &str = "CIRCUIT_APPLICATIVE_WRITE_FACT_TOPOLOGY";
pub const CIRCUIT_UNPACK_SET_IS_LEAF: &str = "CIRCUIT_UNPACK_SET_IS_LEAF";
pub const CIRCUIT_UNPACK_SET_IS_SELF_FOLD: &str = "CIRCUIT_UNPACK_SET_IS_SELF_FOLD";
pub const CIRCUIT_UNPACK_SET_CIRCUIT_HASH_INDEX: &str = "CIRCUIT_UNPACK_SET_CIRCUIT_HASH_INDEX";
pub const CIRCUIT_UNPACK_ENTER_SUBTASK_0: &str = "CIRCUIT_UNPACK_ENTER_SUBTASK_0";
pub const CIRCUIT_UNPACK_ENTER_SUBTASK_1: &str = "CIRCUIT_UNPACK_ENTER_SUBTASK_1";
pub const CIRCUIT_UNPACK_EXIT_SCOPE: &str = "CIRCUIT_UNPACK_EXIT_SCOPE";
pub const CIRCUIT_UNPACK_SET_LEAF_DATA: &str = "CIRCUIT_UNPACK_SET_LEAF_DATA";
