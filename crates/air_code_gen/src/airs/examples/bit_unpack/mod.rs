...
mod tests {
    ...
    use super::test_utils::BitUnpack_e0b35c6b3a8afa3dTestAIR;
    use super::trace::write_trace_cpu;
    use crate::airs::examples::bit_unpack::simd_trace::BitUnpack_e0b35c6b3a8afa3dSimdTraceGenerator;
    use crate::airs::examples::bit_unpack::trace::BitUnpack_e0b35c6b3a8afa3dCpuTraceGenerator;
    ...
    fn test_bit_unpack_constraints() {
        let component = BitUnpack_e0b35c6b3a8afa3d { log_n_instances: 7 };
    ...
    fn test_bit_unpack_cpu_prove() {
        ...
        let fib_trace_gen = BitUnpack_e0b35c6b3a8afa3dCpuTraceGenerator::default();
        registry.register("bit_unpack", fib_trace_gen);

        let inputs = (0..1 << LOG_N_INSTANCES).map(UInt16::from).collect_vec();

        let trace_generator =
            registry.get_generator_mut::<BitUnpack_e0b35c6b3a8afa3dCpuTraceGenerator>("bit_unpack");
        trace_generator.add_inputs(&inputs);
        let trace =
            BitUnpack_e0b35c6b3a8afa3dCpuTraceGenerator::write_trace("bit_unpack", &mut registry);
        let trace_generator =
            registry.get_generator::<BitUnpack_e0b35c6b3a8afa3dCpuTraceGenerator>("bit_unpack");
        let component = trace_generator.component();
        let air = BitUnpack_e0b35c6b3a8afa3dTestAIR { component };
    ...
    fn test_bit_unpack_simd_prove() {
        const LOG_N_INSTANCES: u32 = 7;
        let mut registry = ComponentGenerationRegistry::default();
        let fib_trace_gen = BitUnpack_e0b35c6b3a8afa3dSimdTraceGenerator::default();
        registry.register("bit_unpack", fib_trace_gen);
        ...
        let trace_generator = registry
            .get_generator_mut::<BitUnpack_e0b35c6b3a8afa3dSimdTraceGenerator>("bit_unpack");
        trace_generator.add_inputs(&inputs);
        let trace =
            BitUnpack_e0b35c6b3a8afa3dSimdTraceGenerator::write_trace("bit_unpack", &mut registry);
        let trace_generator =
            registry.get_generator::<BitUnpack_e0b35c6b3a8afa3dSimdTraceGenerator>("bit_unpack");
        let component = trace_generator.component();
        let air = BitUnpack_e0b35c6b3a8afa3dTestAIR { component };
