...
use crate::components_code_gen::circuit_constraints::component_gen::generate_circuit_constraints_code;
...
pub fn format_air_fn_code(code: String, code_type: AutogenCodeType) -> String {
    match code_type {
        AutogenCodeType::WITNESS | AutogenCodeType::CIRCUIT | AutogenCodeType::AIR => {
