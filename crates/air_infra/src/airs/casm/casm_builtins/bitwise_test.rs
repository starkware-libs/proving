...
fn test_big_felt252_bitwise_builtin() {
    ...
    let air_body_vec = [
        ...
        "state[57] = BitwiseXor_36334f1766571820([state[1], state[29]])",
        "tmp_8 = (const_1073741824 * ((state[1] + state[29]) - state[57]))",
        "state[58] = BitwiseXor_36334f1766571820([state[2], state[30]])",
        "tmp_11 = (const_1073741824 * ((state[2] + state[30]) - state[58]))",
        "state[59] = BitwiseXor_36334f1766571820([state[3], state[31]])",
        "tmp_14 = (const_1073741824 * ((state[3] + state[31]) - state[59]))",
        "state[60] = BitwiseXor_36334f1766571820([state[4], state[32]])",
        "tmp_17 = (const_1073741824 * ((state[4] + state[32]) - state[60]))",
        "state[61] = BitwiseXor_36334f1766571820([state[5], state[33]])",
        "tmp_20 = (const_1073741824 * ((state[5] + state[33]) - state[61]))",
        "state[62] = BitwiseXor_36334f1766571820([state[6], state[34]])",
        "tmp_23 = (const_1073741824 * ((state[6] + state[34]) - state[62]))",
        "state[63] = BitwiseXor_36334f1766571820([state[7], state[35]])",
        "tmp_26 = (const_1073741824 * ((state[7] + state[35]) - state[63]))",
        "state[64] = BitwiseXor_36334f1766571820([state[8], state[36]])",
        "tmp_29 = (const_1073741824 * ((state[8] + state[36]) - state[64]))",
        "state[65] = BitwiseXor_36334f1766571820([state[9], state[37]])",
        "tmp_32 = (const_1073741824 * ((state[9] + state[37]) - state[65]))",
        "state[66] = BitwiseXor_36334f1766571820([state[10], state[38]])",
        "tmp_35 = (const_1073741824 * ((state[10] + state[38]) - state[66]))",
        "state[67] = BitwiseXor_36334f1766571820([state[11], state[39]])",
        "tmp_38 = (const_1073741824 * ((state[11] + state[39]) - state[67]))",
        "state[68] = BitwiseXor_36334f1766571820([state[12], state[40]])",
        "tmp_41 = (const_1073741824 * ((state[12] + state[40]) - state[68]))",
        "state[69] = BitwiseXor_36334f1766571820([state[13], state[41]])",
        "tmp_44 = (const_1073741824 * ((state[13] + state[41]) - state[69]))",
        "state[70] = BitwiseXor_36334f1766571820([state[14], state[42]])",
        "tmp_47 = (const_1073741824 * ((state[14] + state[42]) - state[70]))",
        "state[71] = BitwiseXor_36334f1766571820([state[15], state[43]])",
        "tmp_50 = (const_1073741824 * ((state[15] + state[43]) - state[71]))",
        "state[72] = BitwiseXor_36334f1766571820([state[16], state[44]])",
        "tmp_53 = (const_1073741824 * ((state[16] + state[44]) - state[72]))",
        "state[73] = BitwiseXor_36334f1766571820([state[17], state[45]])",
        "tmp_56 = (const_1073741824 * ((state[17] + state[45]) - state[73]))",
        "state[74] = BitwiseXor_36334f1766571820([state[18], state[46]])",
        "tmp_59 = (const_1073741824 * ((state[18] + state[46]) - state[74]))",
        "state[75] = BitwiseXor_36334f1766571820([state[19], state[47]])",
        "tmp_62 = (const_1073741824 * ((state[19] + state[47]) - state[75]))",
        "state[76] = BitwiseXor_36334f1766571820([state[20], state[48]])",
        "tmp_65 = (const_1073741824 * ((state[20] + state[48]) - state[76]))",
        "state[77] = BitwiseXor_36334f1766571820([state[21], state[49]])",
        "tmp_68 = (const_1073741824 * ((state[21] + state[49]) - state[77]))",
        "state[78] = BitwiseXor_36334f1766571820([state[22], state[50]])",
        "tmp_71 = (const_1073741824 * ((state[22] + state[50]) - state[78]))",
        "state[79] = BitwiseXor_36334f1766571820([state[23], state[51]])",
        "tmp_74 = (const_1073741824 * ((state[23] + state[51]) - state[79]))",
        "state[80] = BitwiseXor_36334f1766571820([state[24], state[52]])",
        "tmp_77 = (const_1073741824 * ((state[24] + state[52]) - state[80]))",
        "state[81] = BitwiseXor_36334f1766571820([state[25], state[53]])",
        "tmp_80 = (const_1073741824 * ((state[25] + state[53]) - state[81]))",
        "state[82] = BitwiseXor_36334f1766571820([state[26], state[54]])",
        "tmp_83 = (const_1073741824 * ((state[26] + state[54]) - state[82]))",
        "state[83] = BitwiseXor_36334f1766571820([state[27], state[55]])",
        "tmp_86 = (const_1073741824 * ((state[27] + state[55]) - state[83]))",
        "state[84] = BitwiseXor_36334f1766571820([state[28], state[56]])",
