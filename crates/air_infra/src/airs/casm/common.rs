...
pub fn opcode_from_flags(
    flag_dst_register: BoolExpr,
    flag_op0_register: BoolExpr,
    ...
    flag_ap_update_add1: BoolExpr,
    flag_opcode_call: BoolExpr,
    flag_opcode_ret: BoolExpr,
    flag_opcode_assert_eq: BoolExpr,
) -> UInt16Expr {
    &(&(&(&(&flag_dst_register.as_uint16() << &const_u16_expr!(DST_REG_BIT))
        + &(&flag_op0_register.as_uint16() << &const_u16_expr!(OP0_REG_BIT)))
        ...
        + &(&(&(&(&flag_pc_update_jump_rel.as_uint16() << &const_u16_expr!(PC_JUMP_REL_BIT))
            ...
            + &(&(&flag_ap_update_add.as_uint16() << &const_u16_expr!(AP_ADD_BIT))
                + &(&flag_ap_update_add1.as_uint16() << &const_u16_expr!(AP_ADD1_BIT))))
